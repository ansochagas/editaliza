    ...
    async (req, res) => {
        ...
        try {
            ...
            if (!hasPendingNewTopics) {
                ...
                // CORREÇÃO: Simulados direcionados só após todo conteúdo ser abordado
                if (pendingTopics.length === 0 && progressPercentage >= 0.05) {
                ...
                if (pendingTopics.length === 0 && completedTopics.length >= 3) {
                ...
                if (pendingTopics.length === 0 && progressPercentage >= 0.15) {
